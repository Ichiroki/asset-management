...
@section('main')
    ...
    <div class="w-full flex flex-col md:flex-row justify-between gap-7">
        <div class="bg-sky-400 dark:bg-sky-800 w-full px-5 py-7 rounded-md relative overflow-hidden">
            ...
            <div class="w-36 h-36 rounded-full absolute top-[-3.7rem] left-[-3.5rem] bg-slate-900 opacity-20"></div>
            <div>
        ...
        <div class="bg-amber-400 dark:bg-amber-800 w-full px-5 py-7 rounded-md relative overflow-hidden">
        ...
        <div class="bg-emerald-400 dark:bg-emerald-800 w-full px-5 py-7 rounded-md relative overflow-hidden">
        ...
        <div class="bg-purple-400 dark:bg-purple-800 w-full px-5 py-7 rounded-md relative overflow-hidden">
