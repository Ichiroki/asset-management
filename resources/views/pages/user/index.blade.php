...
@section('main')
    ...
    <div class="flex flex-col justify-between">
        <div class="flex justify-between">
            ...
            <form action="{{ route('user.index', request()->query()) }}" class="flex gap-3">
                ...
                @foreach ($users as $user)
                    <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                        ...
                        <th scope="row"
                            ...
                            <img class="w-10 h-10 rounded-full bg-slate-200" src="/storage/img/{{ $user->avatar }}"
                                alt="Jese image">
                            <div class="pl-3">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center">
                                ...
                                <x-modal-box value="{{ $user->id }}">
                                    ...
                                    <form action="{{ route('user.destroy', ['user' => $user->id]) }}" class="inline"
                                        method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
