...
@section('main')
    ...
    <div class="flex flex-col justify-between">
        <div class="flex justify-between items-center">
            <a href="{{ route('vehicleLoans.create') }}"
                    ...
                    dark:bg-gray-900 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center">
                                <a href="{{ route('vehicleLoans.show', ['vehicle' => $vehicle->id]) }}"
                                ...
                                <a href="{{ route('vehicleLoans.edit', ['vehicle' => $vehicle->id]) }}"
                                    class="@if (Auth::user()->hasRole('approval_bod')) hidden @endif px-3 py-2 mb-2 mr-2 text-sm font-medium text-center text-blue-700 transition border border-blue-700 rounded-lg hover:text-white hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:border-blue-500 dark:text-blue-500 dark:hover:text-white dark:hover:bg-blue-600 dark:focus:ring-blue-800">
                                    Edit
                                </a>
                                <button data-modal-target="popup-modal-{{ $vehicle->id }}"
                                    data-modal-toggle="popup-modal-{{ $vehicle->id }}"
                                    class="
                                ...
                                <x-modal-box value="{{ $vehicle->id }}">
                                    ...
                                    <form action="{{ route('vehicleLoans.destroy', ['vehicle' => $vehicle->id]) }}"
                                        ...
                                        <button data-modal-hide="popup-modal-{{ $vehicle->id }}" type="button"
