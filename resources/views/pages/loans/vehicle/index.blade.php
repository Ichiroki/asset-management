...
<h1 class="pb-2 mb-6 text-3xl border-b-4 border-slate-800 w-fit dark:text-slate-200 dark:border-slate-200">Peminjaman Kendaraan</h1>
        <div class="flex flex-col justify-between">
            <div class="flex justify-between">
                ...
                <form action="{{ route('search.vehicleLoans') }}">
        ...
        <div class="relative mt-6 overflow-x-auto shadow-md sm:rounded-lg">
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    ...
                    <tr class="text-center bg-white border-b shadow-inner
                    @if($vehicle->loan_status === "Waiting Approval") shadow-amber-500/50 @endif
                    ...
                    dark:bg-gray-900 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center">
                                ...
                                <a href="{{ route('vehicleLoans.edit', ['vehicle' => $vehicle->id]) }}" class="@if(Auth::user()->hasRole('approval_bod')) hidden @endif px-3 py-2 mb-2 mr-2 text-sm font-medium text-center text-blue-700 transition border border-blue-700 rounded-lg hover:text-white hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:border-blue-500 dark:text-blue-500 dark:hover:text-white dark:hover:bg-blue-600 dark:focus:ring-blue-800">
                                    Edit
                                </a>
                                <button data-modal-target="popup-modal-{{ $vehicle->id }}" data-modal-toggle="popup-modal-{{ $vehicle->id }}" class="
