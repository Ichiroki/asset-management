...
<x-card>
    ...
    <x-slot name="content">
        <form action="{{ route('laptop.store') }}" method="POST" novalidate>
            ...
            <div class="mb-6">
                <label for="assets" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Asset</label>
