...
@section('main')
    ...
    @endif
    <div class="md:py-12 md:px-20 sm:px-12 sm:py-6 px-6 py-2 rounded-3xl glassmorphism-light dark:glassmorphism-dark relative overflow-hidden">
        ...
        <div class="flex flex-col lg:flex-row mt-28">
            <div class="lg:w-1/2 md:px-7 z-10 mb-10 lg:mb-0">
                ...
                <input id="avatar" type="file" name="avatar" accept="image/png, image/jpg, image/jpeg" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="avatar_help">
            ...
            <div class="lg:w-1/2 border-slate-400 md:px-7">
                ...
                <div class="mb-6">
                    ...
                    <input type="password" id="confPassword" name="confPassword" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    @error('confPassword')
                        <p class="mt-2 text-sm text-red-600 dark:text-red-500">
                            <span class="font-medium">{{ $message }}</span>
                        </p>
