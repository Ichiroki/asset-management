...
@section('main')
    <div class="bg-slate-700 py-12 px-20 rounded-3xl">
        ...
        <div class="flex mt-28">
            <div class="w-1/2 px-7">
                ...
                <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="avatar_help" id="avatar" type="file">
            ...
            <div class="w-1/2 border-slate-400 px-7">
                ...
                <div class="mt-6">
                    <input type="submit" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800" value="Submit">
                </div>
            </div>
        </form>
    </div>
