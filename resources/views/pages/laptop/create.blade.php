    ...
    <x-slot name="content">
        <form action="{{ route('laptop.store') }}" method="POST" novalidate>
            ...
            <div class="mb-6">
                ...
                <input type="text" id="name" name="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" value="{{ old('name') }}" autocomplete="off" autofocus required>
                @error('name')
            ...
            <div>
                ...
                <div class="flex flex-col lg:flex-row justify-between lg:items-center gap-3">
                    <div class="mb-6 w-1/2">
                        ...
                        <input type="text" id="main_storage" name="main_storage" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" autocomplete="off" value="{{ old('main_storage') }}" autofocus required>
                        @error('main_storage')
                            <p class="mt-2 text-sm text-red-600 dark:text-red-500"><span class="font-medium">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="mb-6 w-1/2">
                        <label for="extend_storage" class="lg:text-end block mb-2 text-sm font-medium text-gray-900 dark:text-white">Extends</label>
                        <input type="text" id="extend_storage" name="extend_storage" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" autocomplete="off" value="{{ old('extend_storage') }}" autofocus required>
